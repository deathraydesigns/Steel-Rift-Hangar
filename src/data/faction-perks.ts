...
export const MT_COORDINATED_ASSAULTS = 'MT_COORDINATED_ASSAULTS' as const;
export const MT_COVERED_ADVANCES = 'MT_COVERED_ADVANCES' as const;
export const MT_ELITE_PILOT_PROGRAM = 'MT_ELITE_PILOT_PROGRAM' as const;
export const PP_EXPANSIONIST = 'PP_EXPANSIONIST' as const;
export const PP_PROTECTIVIST = 'PP_PROTECTIVIST' as const;
export const PP_IDEOLOGICAL = 'PP_IDEOLOGICAL' as const;
export const OI_ORBITAL_STOCKPILES = 'OI_ORBITAL_STOCKPILES' as const;
export const OI_STRATEGIC_ENERGY_RESERVES = 'OI_STRATEGIC_ENERGY_RESERVES' as const;
export const OI_MATERIEL_STOCKPILES = 'OI_MATERIEL_STOCKPILES' as const;
export const E_EMBEDDED_INFORMANTS = 'E_EMBEDDED_INFORMANTS' as const;
export const E_PAID_SABOTEURS = 'E_PAID_SABOTEURS' as const;
export const E_EXHAUSTIVE_INTEL_GATHERING = 'E_EXHAUSTIVE_INTEL_GATHERING' as const;
export const RD_ADVANCED_HARDPOINT_DESIGN = 'RD_ADVANCED_HARDPOINT_DESIGN' as const;
export const RD_ADVANCED_ENERGY_MANAGEMENT_SYSTEMS = 'RD_ADVANCED_ENERGY_MANAGEMENT_SYSTEMS' as const;
export const RD_ADVANCED_STRUCTURAL_COMPONENTS = 'RD_ADVANCED_STRUCTURAL_COMPONENTS' as const;
export const DWC_TOP_END_HARDWARE = 'DWC_TOP_END_HARDWARE' as const;
export const DWC_OUTRAGEOUS_SUPPORT_BUDGET = 'DWC_OUTRAGEOUS_SUPPORT_BUDGET' as const;
export const DWC_PURCHASED_OUTCOMES = 'DWC_PURCHASED_OUTCOMES' as const;
export const RA_UNPREDICTABLE_GAMBITS = 'RA_UNPREDICTABLE_GAMBITS' as const;
export const RA_RECKLESS_PILOTING = 'RA_RECKLESS_PILOTING' as const;
export const RA_BAIT_AND_SWITCH = 'RA_BAIT_AND_SWITCH' as const;
export const UA_NETWORK_HACKERS = 'UA_NETWORK_HACKERS' as const;
export const UA_TECH_PIRATES_ADVANCED_HARDPOINT_DESIGN = 'UA_TECH_PIRATES_ADVANCED_HARDPOINT_DESIGN' as const;
export const UA_TECH_PIRATES_ADVANCED_ENERGY_MANAGEMENT_SYSTEM = 'UA_TECH_PIRATES_ADVANCED_ENERGY_MANAGEMENT_SYSTEM' as const;
export const UA_TECH_PIRATES_ADVANCED_STRUCTURAL_COMPONENTS = 'UA_TECH_PIRATES_ADVANCED_STRUCTURAL_COMPONENTS' as const;
export const UA_INTIMIDATION_TACTICS = 'UA_INTIMIDATION_TACTICS' as const;
export const BLO_EX_MILITARY_VETERANS = 'BLO_EX_MILITARY_VETERANS' as const;
export const BLO_POLITICAL_EXTREMISTS_EXPANSIONIST = 'BLO_POLITICAL_EXTREMISTS_EXPANSIONIST' as const;
export const BLO_POLITICAL_EXTREMISTS_PROTECTIVIST = 'BLO_POLITICAL_EXTREMISTS_PROTECTIVIST' as const;
export const BLO_POLITICAL_EXTREMISTS_IDEOLOGICAL = 'BLO_POLITICAL_EXTREMISTS_IDEOLOGICAL' as const;
export const BLO_DISGRACED_TRILLIONAIRE_TOP_END_HARDWARE = 'BLO_DISGRACED_TRILLIONAIRE_TOP_END_HARDWARE' as const;
export const BLO_DISGRACED_TRILLIONAIRE_OUTRAGEOUS_SUPPORT_BUDGET = 'BLO_DISGRACED_TRILLIONAIRE_OUTRAGEOUS_SUPPORT_BUDGET' as const;
export const BLO_DISGRACED_TRILLIONAIRE_PURCHASED_OUTCOMES = 'BLO_DISGRACED_TRILLIONAIRE_PURCHASED_OUTCOMES' as const;

export type FactionPerkId =
    | typeof MT_COORDINATED_ASSAULTS
    | typeof MT_COVERED_ADVANCES
    | typeof MT_ELITE_PILOT_PROGRAM
    | typeof PP_EXPANSIONIST
    | typeof PP_PROTECTIVIST
    | typeof PP_IDEOLOGICAL
    | typeof OI_ORBITAL_STOCKPILES
    | typeof OI_STRATEGIC_ENERGY_RESERVES
    | typeof OI_MATERIEL_STOCKPILES
    | typeof E_EMBEDDED_INFORMANTS
    | typeof E_PAID_SABOTEURS
    | typeof E_EXHAUSTIVE_INTEL_GATHERING
    | typeof RD_ADVANCED_HARDPOINT_DESIGN
    | typeof RD_ADVANCED_ENERGY_MANAGEMENT_SYSTEMS
    | typeof RD_ADVANCED_STRUCTURAL_COMPONENTS
    | typeof DWC_TOP_END_HARDWARE
    | typeof DWC_OUTRAGEOUS_SUPPORT_BUDGET
    | typeof DWC_PURCHASED_OUTCOMES
    | typeof RA_UNPREDICTABLE_GAMBITS
    | typeof RA_RECKLESS_PILOTING
    | typeof RA_BAIT_AND_SWITCH
    | typeof UA_NETWORK_HACKERS
    | typeof UA_TECH_PIRATES_ADVANCED_HARDPOINT_DESIGN
    | typeof UA_TECH_PIRATES_ADVANCED_ENERGY_MANAGEMENT_SYSTEM
    | typeof UA_TECH_PIRATES_ADVANCED_STRUCTURAL_COMPONENTS
    | typeof UA_INTIMIDATION_TACTICS
    | typeof BLO_EX_MILITARY_VETERANS
    | typeof BLO_POLITICAL_EXTREMISTS_EXPANSIONIST
    | typeof BLO_POLITICAL_EXTREMISTS_PROTECTIVIST
    | typeof BLO_POLITICAL_EXTREMISTS_IDEOLOGICAL
    | typeof BLO_DISGRACED_TRILLIONAIRE_TOP_END_HARDWARE
    | typeof BLO_DISGRACED_TRILLIONAIRE_OUTRAGEOUS_SUPPORT_BUDGET
    | typeof BLO_DISGRACED_TRILLIONAIRE_PURCHASED_OUTCOMES;
...
export interface FactionPerk {
    ...
    optional_perks?: FactionPerkId[];
    prefix?: string;
    copied_perk_id?: FactionPerkId;
}
...
export const FACTION_PERKS: Readonly<Record<FactionPerkId, FactionPerk>> = makeFrozenStaticListIds<FactionPerk>(
    Object.assign(
        {},
        PERKS_INPUT,
        {
...
function makePerkCopy(prefix: string, perkId: FactionPerkId): Omit<FactionPerk, 'id'> {
...
export function isMatchingPerkOrCopy(equalToPerkId: FactionPerkId, targetPerkId: FactionPerkId | string | undefined | null): boolean {
    if (!targetPerkId) {
        return false;
    }
    ...
    const perk = FACTION_PERKS[targetPerkId as FactionPerkId];
