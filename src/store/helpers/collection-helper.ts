...
export function moveItem<ID extends string | number, T extends HasDisplayOrder & { id: ID }>(items: T[], item: T, toIndex: number) {
...
export function findById<ID extends string | number, T extends { id: ID }>(collection: T[], id: ID): T | undefined {
